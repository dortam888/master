...
static int ForMayaCmpFunc(const void * a, const void * b) 
{
    assert(NULL != a);
    assert(NULL != b);
                          ...
                          int(*cmp)(const void*, const void*))) 
{
    ...
    sort_function(arr01, 1, sizeof(int), ForMayaCmpFunc);
    qsort(arr02, 1, sizeof(int), CmpFunc);
    ...
    sort_function(arr11, 8, sizeof(int), ForMayaCmpFunc);
    qsort(arr12, 8, sizeof(int), CmpFunc);
    ...
    sort_function(arr21, 8, sizeof(int), ForMayaCmpFunc);
    qsort(arr22, 8, sizeof(int), CmpFunc);
    ...
    sort_function(arr31, 8, sizeof(int), ForMayaCmpFunc);
    qsort(arr32, 8, sizeof(int), CmpFunc);
    ...
    sort_function(arr41, 8, sizeof(int), ForMayaCmpFunc);
    qsort(arr42, 8, sizeof(int), CmpFunc);
