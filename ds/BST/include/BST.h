...
/* This file contains functions for BST (binary search tree) data structure */
/* operations. */
/* Can be used for BST based algorithms */
/*############################################################################*/
 ...
 * Errors : if iter is first, behaviour is undefined 
 */
 ...
 * Return : iter to invalid iter ENDLONG_MIN
 * Errors : --
 */
